...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <PawPrint className="absolute top-20 left-[10%] w-12 h-12 text-teal-400/20 animate-float" />
      <PawPrint className="absolute top-40 right-[15%] w-8 h-8 text-amber-400/20 animate-float-delayed" />
      <PawPrint className="absolute bottom-40 left-[20%] w-10 h-10 text-teal-300/15 animate-float-delayed" />
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <FadeIn delay={0.2}>
          ...
          >
            ...
            <span className="text-sm text-teal-200 tracking-wider uppercase font-medium">
        ...
        <FadeIn delay={0.6}>
          <p className="text-lg md:text-xl text-teal-100/80 max-w-3xl mx-auto mb-10 leading-relaxed">
